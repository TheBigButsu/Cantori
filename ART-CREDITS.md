...
thanks. Sprites used: player, rat, bat, adder (snake), wolf spider, dagger,
short sword, mace, leather armour, chain mail, crystal plate, potion, scroll,
stone stairs, pebble floor, brick wall.
...
originally published under other names. Renaming a file changes nothing about the
art's origin, and the credit above covers it either way.
