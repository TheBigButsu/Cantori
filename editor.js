  ...
  const REFERENCE = [
    ...
    },
    {
      ...
      rows: [
        ...
        { name: "Armour Class", formula: "AC = 10 + the DEX modifier your armour lets through + passive AC (Happy Feet) + any timed AC bonus", note: "How much DEX gets through is the whole difference between the three armours. NOTHING: all of it, uncapped — armour caps DEX because it is in the way, and nothing is in the way of a bare body. MEDIUM: 2 + tier + plus, so a tier-1 piece already carries +3 and each tier and each upgrade scroll adds another; this is the DEX-build armour, soaking a little and mostly making you hard to hit. LIGHT and HEAVY: none at all. Armour itself grants no flat AC. Spending past your own modifier is wasted — the cap never invents DEX you do not have." },
    ...
    },
    {
      ...
      rows: [
        { name: "Evasion (dodge)", formula: "after an attack roll has already beaten your AC, chance = min(50%, evasion points x 2% + flat evade% from passives) — ZERO in heavy armour", note: "Evasion is NOT Armour Class and does not feed it. AC is how hard you are to aim at; Evasion is dodging a blow that was aimed true. Heavy armour cannot dodge at all: it answers a blow by absorbing it, which is what its mitigation range is for. The points are suppressed while the plate is worn, not spent — take it off and they are all still there, so committing to Ourn's coin or Happy Feet never becomes a trap. A d20 AC point is worth about 5%, so Evasion is cheaper per point and hard-capped at half." },
