  ...
  const REFERENCE = [
    ...
    },
    {
      ...
      rows: [
        ...
        { name: "progression (Classes tab)", formula: "toHitPerLevel \u00b7 toHitOddLevels \u00b7 evaPctEvenLevels \u00b7 mpRegenIntPerLevel", note: "Chadwick takes +1 to hit every level. Brynn alternates: +1 to hit on odd levels, +1% dodge on even ones. ToneTum takes neither and instead adds 0.1 to the INT modifier that drives MANA REGEN only \u2014 the same dial the stat already turns, moved a tenth at a time, so his levels are felt between fights rather than in them. Dodge from this shares the one 50% cap with everything else." },
    ...
    },
    {
      ...
      rows: [
        { name: "The promise", formula: "every empty pocket either hides a room or is filled in \u2014 a passage that exists goes somewhere", note: "A patch of ground with one way in and nothing inside costs real turns against the Horror clock and pays nothing, and you cannot tell it from a passage that leads somewhere until you have walked it. Measured: 2.65 such pockets survived generation per floor before this, and 0.45 after, with 41 of 60 floors now completely clean." },
        { name: "What counts as a pocket", formula: "ground stranded when a single tile is blocked, at most 14 tiles, containing no stairs and no loot", note: "Found by cutting rather than by counting neighbours. The one-neighbour test misses these entirely \u2014 a three-tile grass nook has plenty of neighbours \u2014 which is why a floor that FELT full of pointless spokes measured as having almost none. Bigger than 14 tiles is a wing of the floor, not a nook, and is left alone." },
